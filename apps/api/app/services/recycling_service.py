DEFAULT_GUIDANCE: dict[str, list[str]] = {
    "Plastic": [
        "Empty and rinse the item.",
        "Check the local resin-code rules.",
        "Keep plastic bags out of mixed recycling.",
    ],
    ...
    "Hazardous waste": [
        "Do not place it in household recycling.",
...
def guidance_for(category: str) -> list[str]:
    return DEFAULT_GUIDANCE.get(
        category, ["Follow the disposal guidance provided by your local authority."]
    )
